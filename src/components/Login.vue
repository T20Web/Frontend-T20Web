      ...
      <form class="form" @submit.prevent="submit" novalidate>
        ...
        <label class="field">
          ...
          <div class="input-wrap">
            <svg class="icon" viewBox="0 0 24 24" aria-hidden><path d="M2 6.5A2.5 2.5 0 014.5 4h15A2.5 2.5 0 0122 6.5v11A2.5 2.5 0 0119.5 20h-15A2.5 2.5 0 012 17.5z" fill="currentColor"/></svg>
            <input
              type="email"
              v-model.trim="email"
              required
        ...
        <label class="field">
          ...
          <div class="input-wrap">
            <svg class="icon" viewBox="0 0 24 24" aria-hidden><path d="M6 10v-2a6 6 0 1112 0v2" fill="none" stroke="currentColor" stroke-width="1.6"/></svg>
            <input
              ...
              aria-label="Senha"
            />
            <button type="button" class="btn-icon" @click="showPassword = !showPassword" :aria-pressed="showPassword" :title="showPassword ? 'Ocultar senha' : 'Mostrar senha'">
...
.icon { width:18px; height:18px; opacity:0.7; color:var(--muted); }
