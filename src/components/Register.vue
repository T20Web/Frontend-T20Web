    ...
    <section class="auth-card" role="main" aria-labelledby="register-title">
      ...
      <form class="form" @submit.prevent="submit" novalidate>
        ...
        <label class="field">
          ...
          <small v-if="password && password.length < 8" class="hint error">Senha precisa ter ao menos 8
            caracteres</small>
        </label>
        ...
        <label class="field">
          ...
          <small v-if="confirmPassword && confirmPassword !== password" class="hint error">As senhas não
            coincidem</small>
        </label>
